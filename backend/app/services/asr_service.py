...
class AsrService:
    ...
    def load_model(self) -> None:
        ...
        try:
            ...
            raise AppError(
                ...
                (
                    "qwen-asr and torch are required when ASR_MOCK=false. "
    ...
    def _transcribe_chunked(
        ...
        for start in range(0, len(audio), chunk_samples):
            ...
            print(
                f"\n[ASR chunk {chunk_index}/{total_chunks}] "
            ...
            print(f"Language: {result.language or 'unknown'}", flush=True)
            print(chunk_text if chunk_text else "(empty)", flush=True)
            logger.info(
    ...
    def transcribe(
        ...
        if self.settings.asr_mock:
            return AsrResult(
                text="This is a mock transcript generated by Finch.",
        ...
        try:
            ...
            print("\n[ASR single pass] transcribing full audio", flush=True)
            results = self._model.transcribe(
                audio=audio_path,
                language=resolved_language,
            )
