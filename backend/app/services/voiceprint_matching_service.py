...
from app.services.voiceprint_embedding_service import embedding_from_json
    ...
    def resolve_display_names(
        ...
        for cluster_id in cluster_ids:
            ...
            if profile_id and confidence >= threshold:
                ...
                logger.debug(
                    "Voiceprint match cluster=%s: matched profile=%s name=%r score=%.3f threshold=%.3f",
                    cluster_id,
                    profile_id,
                ...
                logger.debug(
                    "Voiceprint match cluster=%s: below threshold best=%s score=%.3f threshold=%.3f all_scores=%s",
                    cluster_id,
                    profile_id,
